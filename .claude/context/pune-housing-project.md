[PuneProp Predict](https://www.punehousing.in/)

[Predictor](https://www.punehousing.in/) [Insights](https://www.punehousing.in/insights) [About](https://www.punehousing.in/about)
...
[![Deployment](https://img.shields.io/badge/Live%20App-pune.adityajoshi.in-brightgreen)](https://pune.adityajoshi.in/)[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)[![GitHub Repo](https://img.shields.io/badge/GitHub-Repo-blue)](https://github.com/joshiaditya0511/pune-house-price-prediction)
...
- [Overview](https://www.punehousing.in/about#overview)
- [How It Works (Technical Flow)](https://www.punehousing.in/about#how-it-works-technical-flow)
  - [Current Architecture (Client-Side with ONNX)](https://www.punehousing.in/about#current-architecture-client-side-with-onnx)
  - [Previous Architecture (Server-Side)](https://www.punehousing.in/about#previous-architecture-server-side)
- [Methodology](https://www.punehousing.in/about#methodology)
  - [Data Acquisition](https://www.punehousing.in/about#data-acquisition)
  - [Data Preprocessing & EDA](https://www.punehousing.in/about#data-preprocessing--eda)
  - [Feature Engineering & Selection](https://www.punehousing.in/about#feature-engineering--selection)
  - [Price Prediction Model Training](https://www.punehousing.in/about#price-prediction-model-training)
  - [Recommendation System Development](https://www.punehousing.in/about#recommendation-system-development)
- [Technology Stack](https://www.punehousing.in/about#technology-stack)
- [Deployment](https://www.punehousing.in/about#deployment)
  - [Current Architecture (Client-Side with ONNX)](https://www.punehousing.in/about#current-architecture-client-side-with-onnx-1)
  - [Previous Architecture (Server-Side)](https://www.punehousing.in/about#previous-architecture-server-side-1)
- [Project Versions](https://www.punehousing.in/about#project-versions)
- [Future Enhancements](https://www.punehousing.in/about#future-enhancements)
...
![Current Architecture Diagram](https://www.punehousing.in/PHPPcurrent.svg)
...
![Previous Architecture Diagram](https://www.punehousing.in/PHPPold.svg)
...
2. **Sequential API Requests:** Upon submission, the frontend makes **synchronous** POST requests to the backend API (`phpp-api.adityajoshi.in`), hosted on AWS EC2:
   ...
   - **Second:** After receiving the price prediction, a _separate_ request is sent to `/recommend` with the same features.
3. **Backend Processing (FastAPI):**
   ...
   - **Recommendation Request (`/recommend`):**
     ...
     - The relevant pre-loaded preprocessing steps (e.g., scaling, encoding for the _remaining_ features) are applied.
...
- **Features Used:** The same features selected for the price prediction model were used for finding neighbors, _except_ for `LocalityName`. Including locality would require one-hot encoding, drastically increasing dimensionality and potentially reducing the effectiveness of distance-based neighbor searches (curse of dimensionality).
- **Implementation:**
...
- **Version 1.0 (Iteration\_1):** Initial working version with imputation for missing values in selected features.
- **Version 1.1 (Iteration\_2):** Instead of imputation, rows with missing values in the _final selected features_ were dropped. This reduced the dataset size but avoided potentially inaccurate imputations.
- **Version 1.2 (Iteration\_3):** The dataset was completely rescraped (approx. 3 months after the previous scrape) to ensure data freshness for pricing and recommendations. The entire pipeline (cleaning, EDA, feature selection, training) was re-run on this new data.
...
_(Code and artifacts for each version can be found in the respective `Iteration_X` folders.)_
...
AI-powered house price insights for Pune. Get accurate property valuations using advanced machine learning algorithms trained on comprehensive market data.

Trusted by property enthusiasts

#### Quick Links

- [Home](https://www.punehousing.in/)
- [Predictor](https://www.punehousing.in/)
- [Insights](https://www.punehousing.in/insights)
- [About](https://www.punehousing.in/about)

#### Connect

[Email](mailto:joshiaditya0511@gmail.com) [GitHub](https://github.com/joshiaditya0511/pune-house-price-prediction) [LinkedIn](https://linkedin.com/in/joshiaditya0511) [Website](https://www.adityajoshi.in/)

© 2025 [Aditya Joshi](https://www.adityajoshi.in/)
. All Rights Reserved.

[Home](https://icons8.com/icon/hmZnke9jb8oq/home) icon by [Icons8](https://icons8.com/)

Built withusing Astro & React